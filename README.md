...
Это - минималистичная файловая база данных: управление таблицами и полями, CRUD-операции, хранение данных в JSON по таблицам и консольный вывод через PrettyTable.

## Возможности
- Управление схемой: create_table, list_tables, drop_table с автоматическим добавлением столбца ID:int в начало.
...
- src/
  - primitive_db/
    ...
    - core.py — операции с таблицами и данными, валидация типов, автогенерация ID.
    - parser.py — разбор команд insert/select/update/delete/info, а также where и set.
    - engine.py — интерактивный цикл, PrettyTable-вывод, интеграция CRUD.
    - main.py — точка входа (main → run).
